...
class Setup:
    ...
    async def setup(
        self, async_client: AsyncClient, mock_schedule_post_data, mock_schedule_data
    ):
...
class TestScheduleRouter:
    class TestPost(Setup):
        ...
        @pytest.mark.asyncio
        async def test_should_return_created_schedule_id(self):
    ...
    class TestGet(Setup):
        @pytest.mark.asyncio
        async def test_should_return_schedule(self):
        ...
        @pytest.mark.asyncio
        async def test_history_should_return_many(self):
        ...
        @pytest.mark.asyncio
        async def test_history_should_return_200(self):
