...
class TestConvertToUTC:
    ...
    def test_should_handle_datetimes(self) -> None:
    ...
    def test_should_handle_strings(self) -> None:
    ...
    def test_should_handle_tz_naive_datetimes(self) -> None:
    ...
    def test_should_handle_tz_naive_strings(self) -> None:
    ...
    def test_should_convert_timezones(self) -> None:
    ...
    def test_should_convert_timezone_strings(self) -> None:
