...
class TestObservationPostRoute:
    ...
    async def setup(
        self, async_client: AsyncClient, mock_observation_data: dict
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_should_return_created_observation_on_success(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_should_return_422_when_missing_instrument_id(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_should_return_422_when_missing_object_name(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_should_return_422_when_missing_pointing_position(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_should_return_422_when_missing_date_range(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_should_return_422_when_missing_external_observation_id(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_should_return_422_when_missing_type(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_should_return_422_when_missing_status(self) -> None:
