...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_schedule_checksum", "schedule", ["checksum"], unique=False, schema="across"
    )
...
def downgrade() -> None:
    ...
    op.drop_index("ix_schedule_checksum", table_name="schedule", schema="across")
    op.create_index(
        "ix_schedule_checksum", "schedule", ["checksum"], unique=True, schema="across"
    )
    ...
    op.drop_table("constraints", schema="across")
    # ### end Alembic commands ###
